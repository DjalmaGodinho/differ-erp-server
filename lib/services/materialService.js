...
const materialService = {
  async listar({ page, pageSize, search, tipoId, statusId, tipoNome, statusNome, ativo }) {
    return await materialRepository.findAll({ page, pageSize, search, tipoId, statusId, tipoNome, statusNome, ativo });
  },
