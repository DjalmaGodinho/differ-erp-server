...
const pedidoService = {
  async listar({ page, pageSize, search, tipoId, statusId, prioridadeId, clienteId, dataInicio, dataFim }) {
    return await pedidoRepository.findAll({ page, pageSize, search, tipoId, statusId, prioridadeId, clienteId, dataInicio, dataFim });
  },
